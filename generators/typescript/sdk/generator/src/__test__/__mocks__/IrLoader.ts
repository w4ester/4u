...
export const IrPaths = {
    MULTI_URL_ENVIRONMENT: path.join(ROOT_DIR, "seed", "ts-sdk", "multi-url-environment", "ir.json"),
    EXAMPLES: path.join(ROOT_DIR, "seed", "ts-sdk", "examples", "examples-with-api-reference", "ir.json")
};
